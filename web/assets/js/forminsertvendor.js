...
var formElementsTypes = ["input", "input", "button"];
var formElementsIds = ["code_debitor", "name_debitor"];
...
var rowsAmount = 50;
var finalData = [];
var labels = ["Код дебитора", "Название"];
...
function createForm() {
    ...
    document
        .getElementById(`${formElementsIds[2]}-${form.id}`)
